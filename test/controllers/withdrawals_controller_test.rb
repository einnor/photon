...
class WithdrawalsControllerTest < ActionController::TestCase
  ...
  test "should create withdrawal" do
    assert_difference('Withdrawal.count') do
      post :create, withdrawal: { amount: @withdrawal.amount, description: @withdrawal.description, member_id: @withdrawal.member_id }
    end
  ...
  test "should update withdrawal" do
    patch :update, id: @withdrawal, withdrawal: { amount: @withdrawal.amount, description: @withdrawal.description, member_id: @withdrawal.member_id }
    assert_redirected_to withdrawal_path(assigns(:withdrawal))
  end
